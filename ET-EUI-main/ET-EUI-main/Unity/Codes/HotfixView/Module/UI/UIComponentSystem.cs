...
namespace ET
{
    ...
    public static class UIComponentSystem
    {
        ...
        public static void UnLoadWindow(this UIComponent self,WindowID id,bool isDispose = true)
        {
            ...
            {
                // TODO 是否释放
                Debug.LogError($"释放窗口资源：{baseWindow.UIPrefabGameObject.name}");
                ResourcesComponent.Instance?.ReleaseAsset(baseWindow.UIPrefabGameObject);
        ...
        private static void LoadBaseWindows(this UIComponent self,  UIBaseWindow baseWindow)
        {
            ...
            ResourcesComponent.Instance.AddressablesManager.LoadAssetAsyncObject<GameObject>(value);


            GameObject go =  ResourcesComponent.Instance.AddressablesManager.LoadAssetAsyncObject<GameObject>(value);//Addressables.LoadAssetAsync<GameObject>(value).WaitForCompletion();
            ...
            baseWindow?.SetRoot(UIRootHelper.GetTargetRoot(baseWindow.WindowData.windowType));
